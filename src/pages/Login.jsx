    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      <div className="w-full max-w-sm p-8 bg-black rounded-lg shadow-lg">
        ...
        >
          {({ errors, touched }) => (
            <Form>
              ...
              <button type="submit" className="w-full py-3 bg-gray-500 text-white font-semibold rounded-lg hover:bg-gray-700 transition duration-300">
                Login
              </button>
            </Form>
          )}
        ...
        <p className="mt-4 text-center text-white text-sm"> Don't have an account?{' '}
          <a href="/signup" className="text-gray-400 hover:underline">Sign up  </a></p>
      </div>
    </div>
  );
}
