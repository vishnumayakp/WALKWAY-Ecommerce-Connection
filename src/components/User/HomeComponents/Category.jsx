...
function Category() {
  return (
    <div>
      ...
      <div className='md:w-[22rem] w-[90%] relative h-64 border  border-gray-300' ><h4 className='font-bold absolute top-3 left-4 text-3xl'>Womens</h4><img className='h-[100%] ' src="https://preview.colorlib.com/theme/cozastore/images/banner-01.jpg.webp" alt="" /></div>
      <div className='md:w-[22rem] w-[90%] relative h-64 border border-gray-300' ><h4 className='font-bold absolute top-3 left-4 text-3xl'>Mens</h4><img className='h-[100%]  ' src="https://preview.colorlib.com/theme/cozastore/images/banner-02.jpg.webp" alt="" /></div>
