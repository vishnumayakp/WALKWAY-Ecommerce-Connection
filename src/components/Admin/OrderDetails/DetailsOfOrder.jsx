  ...
  return (
    ...
    <div class="grid lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 ">
            ...
            <div class="bg-white p-6 shadow-md rounded-md h-[33rem]">
                ...
                <table class="min-w-full bg-white">
                    ...
                    <tr class="border-b">
                            ...
                            <td class="py-2 px-4 flex items-center">
                                <img src={value.image} class="h-10 w-10 mr-4 rounded-md" alt=""/>
                        ...
                        <tr class="border-b">
                            <td class="py-2 px-4">1</td>
                            <td class="py-2 px-4 flex items-center">
                                <img src={kids} class="h-10 w-10 mr-4 rounded-md" alt=""/>
                                <span>kids-shoes</span>
                            </td>
                            <td class="py-2 px-4">1</td>
                            <td class="py-2 px-4">$349</td>
